...
const blogPosts = [
  { 
    ...
    excerpt: "Discover proven methods to expand your English vocabulary quickly and efficiently.", 
    category: "Vocabulary", 
  ...
  { 
    ...
    excerpt: "Learn techniques to perfect your English accent and sound more like a native speaker.", 
  ...
  { 
    ...
    excerpt: "Simplify complex English tenses with our comprehensive guide and examples.", 
    category: "Grammar", 
  ...
  { 
    ...
    excerpt: "Explore the best mobile applications to supplement your English learning journey.", 
  ...
  { 
    ...
    excerpt: "Enhance your professional English with commonly used business idioms and phrases.", 
  ...
  return (
    <div>
      ...
      {filteredPosts.length === 0 && (
        <p className="text-center text-gray-500 mt-8">No blog posts found matching your search.</p>
      )}
    </div>
  )
}
