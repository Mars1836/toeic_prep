...
export function ToeicResponsiveListeningQuestion() {
  ...
  return (
    (<div className="min-h-screen bg-gray-100">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              <span className="font-bold text-xl">TOEIC Prep</span>
            </div>
            <div className="hidden md:flex items-center space-x-4">
              <a href="#" className="text-gray-600 hover:text-gray-900">About</a>
              <a href="#" className="text-gray-600 hover:text-gray-900">Resources</a>
              <a href="#" className="text-gray-600 hover:text-gray-900">Practice Tests</a>
              <a href="#" className="text-gray-600 hover:text-gray-900">Contact</a>
              <a href="#" className="text-gray-600 hover:text-gray-900">TOEIC Full Exam</a>
            </div>
            <Sheet>
              ...
              <SheetContent side="right">
                <nav className="flex flex-col space-y-4">
                  ...
                  <a href="#" className="text-lg font-medium">Practice Tests</a>
                  <a href="#" className="text-lg font-medium">Contact</a>
                  <a href="#" className="text-lg font-medium">TOEIC Full Exam</a>
                </nav>
              </SheetContent>
            </Sheet>
          </div>
          ...
          <div className="lg:w-2/3">
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-sm mb-6">Look at the picture and listen to the sentences. Choose the option that best describes the image.</p>
                ...
                <ScrollArea className="h-[calc(100vh-16rem)]">
                  <div className="grid grid-cols-5 gap-2">
                    {Array.from({length: 100}, (_, i) => i + 1).map(num => (
                      <Button key={num} variant="outline" size="sm" className="h-12 w-12 text-lg">
                        {num}
                      </Button>
                    ))}
                  </div>
      ...
      <nav
        className="lg:hidden bg-white shadow-sm fixed bottom-0 left-0 right-0 z-10">
        <div className="max-w-7xl mx-auto px-4">
              ...
              <SheetContent side="bottom" className="h-[80vh]">
                <div className="p-4">
                  ...
                  <ScrollArea className="h-[calc(80vh-8rem)]">
                    <div className="grid grid-cols-5 gap-2">
                      {Array.from({length: 100}, (_, i) => i + 1).map(num => (
                        <Button key={num} variant="outline" size="sm" className="h-10 w-10">
                          {num}
                        </Button>
                      ))}
                    </div>
