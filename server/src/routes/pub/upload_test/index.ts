...
uploadRouter.post(
  "/",(req: Request, res: Response, next) => {
    ...
    console.log('Generated Random ID:', req.body.randomId); // Log để kiểm tra
    next();
  },
  upload.fields([{ name: 'images' }, { name: 'audioFiles' },{name: "excelFile"}]),handleAsync(async (req: Request, res: Response) => {
      let data = {
