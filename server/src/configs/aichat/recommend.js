...
exports.modelAIRecommend = exports.recommendPrompt = void 0;
const generative_ai_1 = require("@google/generative-ai");
const instance_1 = require("./instance");
const schema = {
    description: "Generate TOEIC improvement suggestions based on test performance data.",
...
const recommendPrompt = (data, targetScore) => {
