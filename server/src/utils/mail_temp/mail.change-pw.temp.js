...
exports.changePwMailTemp = void 0;
const const_1 = require("../../configs/const");
const changePwMailTemp = (otp, email) => {
    return `
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
  <div class="email-container">
    ...
    <div class="button-container">
      <a href="${const_1.constEnv.clientOrigin}/mail/reset-password?otp=${otp}&email=${email}">Reset Password</a>
    </div>
    
    <p class="fallback-link">If the button doesn't work, copy and paste this link into your browser:</p>
    <p class="fallback-link"><a href="${const_1.constEnv.clientOrigin}/mail/reset-password?otp=${otp}&email=${email}">${const_1.constEnv.clientOrigin}/mail/reset-password?otp=${otp}&email=${email}</a></p>
...
exports.changePwMailTemp = changePwMailTemp;
